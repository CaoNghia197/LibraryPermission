...
public abstract class TedPermissionBase {
    ...
    public static boolean isGranted(List<String> permissions) {
    ...
    public static List<String> getDeniedPermissions(List<String> permissions) {
    ...
    public static boolean canRequestPermission(Activity activity, List<String> permissions) {
    ...
    private static boolean isFirstRequest(List<String> permissions) {
        for (String permission : permissions) {
